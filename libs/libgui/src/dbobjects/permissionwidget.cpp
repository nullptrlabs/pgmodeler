...
PermissionWidget::PermissionWidget(QWidget *parent): BaseObjectWidget(parent, ObjectType::Permission)
{
	...
	roles_tab->setHeaderIcon(GuiUtilsNs::getPixmap("uid"),0);
	...
	permissions_tab->setHeaderIcon(GuiUtilsNs::getPixmap("uid"),0);
	permissions_tab->setHeaderLabel(tr("Roles"),1);
	permissions_tab->setHeaderIcon(GuiUtilsNs::getPixmap("role"),1);
	permissions_tab->setHeaderLabel(tr("Privileges"),2);
	permissions_tab->setHeaderIcon(GuiUtilsNs::getPixmap("grant"),2);
